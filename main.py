...
def jogada():
    ...
    jogada = ''
    jogadasValidas = range(0,9)
    print(jogadasValidas)
    while not jogada in jogadasValidas:
        
        jogadaInput = input("Digite a jogada que você quer realizar (0-8)")
        ...
        if jogadaInput.isnumeric():
            ...
            if jogadaInput < 9:
                ...
                print("A sua jogada deve ser entre 0-8")
        else:
            print("A sua jogada deve ser um número entre 0-8")
    return jogadaInput
...
def jogo(map,jogada,player1,player2,vezDoJogador):
    ...
    if map[jogada] == 'X' or map[jogada] == 'O':
        while verificarJogada:
            jogada = input("Essa jogada já foi realizada, digite um novo número (0-8): ")
            if jogada.isnumeric():
                jogada = int(jogada)
...
def verificarVitoria(map,player1,player2):
    ...
    if map[0] == player1 and map[1] == player1 and map[2] == player1 or map[0] == player2 and map[1] == player2 and map[2] == player2:
        jogoDaVelhaVisual(map)
        print("Venceu")
        return False
    elif map[3] == player1 and map[4] == player1 and map[5] == player1 or map[3] == player2 and map[4] == player2 and map[5] == player2:
        jogoDaVelhaVisual(map)
        print("Venceu")
        return False
    elif map[6] == player1 and map[7] == player1 and map[8] == player1 or map[6] == player2 and map[7] == player2 and map[8] == player2:
        jogoDaVelhaVisual(map)
        print("Venceu")
        return False
    elif map[0] == player1 and map[3] == player1 and map[6] == player1 or map[0] == player2 and map[3] == player2 and map[6] == player2:
        jogoDaVelhaVisual(map)
        print("Venceu")
        return False
        ...
        print("Venceu")
        return False
    elif map[0] == player1 and map[4] == player1 and map[8] == player1 or map[0] == player2 and map[4] == player2 and map[8] == player2:
        jogoDaVelhaVisual(map)
        print("Venceu")
        return False
    elif map[2] == player1 and map[4] == player1 and map[6] == player1 or map[2] == player2 and map[4] == player2 and map[6] == player2:
        jogoDaVelhaVisual(map)
        print("Venceu")
        return False
    elif not ' ' in map:
